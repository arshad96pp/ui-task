      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="border-b border-gray-800 pb-2" data-aos="zoom-in">
            ...
            <p className="text-[16px] lg:text-[16px]  text-white">ACTIVE ACCOUNTS</p>
          </div>
          ...
          <div className="border-b border-gray-800 pb-2" data-aos="zoom-in">
            ...
            <p className="text-[16px] lg:text-[16px]  text-white">NFTS MINTED</p>
          </div>
          ...
          <div className="border-b border-gray-800 pb-2" data-aos="zoom-in">
            ...
            <p className="text-[16px] lg:text-[16px]  text-white">
